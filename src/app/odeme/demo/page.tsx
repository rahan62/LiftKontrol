...
export const metadata: Metadata = {
  title: "Demo Ürünü — Satın al",
  description: "Lift Kontrol demo ürünü — güvenli ödeme (iyzico).",
  alternates: { canonical: "/odeme/demo" },
  robots: { index: false, follow: true },
};

export const dynamic = "force-dynamic";

export default async function OdemeDemoPage() {
  const pricing = DEMO_PRODUCT_PRICING;
  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col overflow-y-auto bg-slate-950 text-slate-100">
      ...
      <main className="relative mx-auto w-full max-w-lg flex-1 px-6 py-16">
        ...
        <h1 className="mt-4 text-2xl font-semibold text-white">Demo Ürünü</h1>
        <p className="mt-2 text-sm text-slate-400">
          Test ve ödeme doğrulaması için 1 TL tutarında sabit ürün. Ödeme iyzico güvenli ödeme sayfasında tamamlanır.
        </p>
